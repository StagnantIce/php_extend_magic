...
abstract class AExtendClass {
    ...
    public function __call($name, $ps) {
        ...
        throw new Exception("Method $method not found in objects ". get_called_class() . ',' . implode(', ', static::extend()));
    }
    ...
    public static function __callStatic($name, $ps) {
        ...
        throw new Exception("Static method $method not found in objects ".  get_called_class() . ',' . implode(', ', static::extend()));
    }
    ...
    public function __get($key) {
        ...
        throw new Exception(get_called_class() . ',' . implode(', ', static::extend()) . ' do not have a property named "'. $key . '".');
    }
